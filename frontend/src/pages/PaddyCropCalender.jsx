...
const PaddyCropCalender = () => {
  ...
  const cardItems = [
    { text: "1. Dry & Intermediate Zone (Rainfed)", image: "/images/crop-calender-img1.jpg" },
    { text: "2. Dry & Intermediate Zone (Irrigated)", image: "/images/crop-calender-img2.jpg" },
    { text: "3. Wet Zone", image: "/images/crop-calender-img3.jpg" },
    { text: "4. Integrated Pest Control in Paddy Cultivation", image: "/images/crop-calender-img4.jpg" },
  ];
